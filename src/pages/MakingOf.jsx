  ...
  return (
    <div className="making-of-page">
      ...
      <div className="making-banner-wrapper">
        <img src="https://ehb-mct.github.io/cp-frontend-SophiaRahmoun/assets/banner_sophia.jpg" alt="Banner" className="banner-image" />
      ...
      <div className="making-story-section">
        <div className="making-story-text">
          ...
          <p className="story-author">Charles Perrault and the Brothers Grimm.</p>
        </div>
        <div className="making-story-image-area">
          <img src="https://ehb-mct.github.io/cp-frontend-SophiaRahmoun/assets/cover_sophia.jpg" alt="Cover" className="story-cover" />
          <a href="https://ehb-mct.github.io/cp-frontend-SophiaRahmoun/" target="_blank" rel="noopener noreferrer">
      ...
      <div className="extras-wrapper">
        <div className="extra-block">
          <img src="https://ehb-mct.github.io/cp-frontend-SophiaRahmoun/assets/extra1_sophia.png" alt="extra 1" />
          <p>text 1</p>
        </div>
        <div className="extra-block">
          <img src="https://ehb-mct.github.io/cp-frontend-SophiaRahmoun/assets/extra2_sophia.jpg" alt="extra 2" />
          <p>texy 2</p>
        </div>
        <div className="extra-block">
          <img src="https://ehb-mct.github.io/cp-frontend-SophiaRahmoun/assets/extra3_sophia.jpg" alt="extra 3" />
          <p>text 3</p>
        </div>
      </div>
      </main>
